...
public class TwoInputMovingController extends BoardController implements Initializable {
    ...
    public TwoInputMovingController(Client client, String state, int worker) {
        super(client, state);
        this.worker = worker;
    }
